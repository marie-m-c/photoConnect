...
<body>
	<div class="mx-auto join-wrap-container">
		...
		<div class="join-container join-img d-flex justify-content-center align-items-center">
			<div class="form-wrapper">
				<form:form action="/signin" method="post" modelAttribute="newLogin" class="d-flex flex-column">
					<h2>Login</h2>
